...
(function () {
  ...
  angular.module('ui.grid').constant('uiGridConstants', {
    ...
    CURRENCY_SYMBOLS: ['Ã†â€™', '$', 'Ã‚Â£', '$', 'Ã‚Â¤', 'Ã‚Â¥', 'Ã¡Å¸â€º', 'Ã¢â€šÂ©', 'Ã¢â€šÂ±', 'Ã Â¸Â¿', 'Ã¢â€šÂ«'],
  ...
  angular.module('ui.grid').config(['$provide', function($provide) {
    $provide.decorator('i18nService', ['$delegate', function($delegate) {
      var lang = {
              ...
              groupPanel: {
                  description: 'PÃ…â„¢esuntÃ„â€º zÃƒÂ¡hlavÃƒÂ­ zde pro vytvoÃ…â„¢enÃƒÂ­ skupiny dle sloupce.'
              },
              search: {
                  placeholder: 'Hledat...',
                  showingItems: 'Zobrazuji poloÃ…Â¾ky:',
                  selectedItems: 'VybranÃƒÂ© poloÃ…Â¾ky:',
                  totalItems: 'Celkem poloÃ…Â¾ek:',
                  size: 'Velikost strany:',
                  first: 'PrvnÃƒÂ­ strana',
                  next: 'DalÃ…Â¡ÃƒÂ­ strana',
                  previous: 'PÃ…â„¢edchozÃƒÂ­ strana',
                  last: 'PoslednÃƒÂ­ strana'
              },
              menu: {
                  text: 'Vyberte sloupec:'
              },
              sort: {
                  ascending: 'SeÃ…â„¢adit od A-Z',
                  descending: 'SeÃ…â„¢adit od Z-A',
                  remove: 'Odebrat seÃ…â„¢azenÃƒÂ­'
              },
              column: {
                  hide: 'Schovat sloupec'
              },
              aggregation: {
                  count: 'celkem Ã…â„¢ÃƒÂ¡dkÃ…Â¯: ',
                  sum: 'celkem: ',
                  avg: 'avg: ',
                  min: 'min.: ',
                  max: 'max.: '
              ...
              gridMenu: {
                  ...
                  exporterAllAsCsv: 'Exportovat vÃ…Â¡echny data do csv',
                  exporterVisibleAsCsv: 'Exportovat viditelnÃƒÂ© data do csv',
                  exporterSelectedAsCsv: 'Exportovat vybrannÃƒÂ© data do csv',
                  exporterAllAsPdf: 'Exportovat vÃ…Â¡echny data do pdf',
                  exporterVisibleAsPdf: 'Exportovat viditelnÃƒÂ© data do pdf',
                  exporterSelectedAsPdf: 'Exportovat vybrannÃƒÂ© data do pdf'
              },
              importer: {
                  noHeaders: 'NÃƒÂ¡zvy sloupcÃ…Â¯ se nepodaÃ…â„¢ilo zÃƒÂ­skat, obsahuje soubor zÃƒÂ¡hlavÃƒÂ­?',
                  noObjects: 'Data se nepodaÃ…â„¢ilo zpracovat, obsahuje soubor Ã…â„¢ÃƒÂ¡dky mimo zÃƒÂ¡hlavÃƒÂ­?',
                  invalidCsv: 'Soubor nelze zpracovat, jednÃƒÂ¡ se CSV?',
                  invalidJson: 'Soubor nelze zpracovat, je to JSON?',
                  jsonNotArray: 'Soubor musÃƒÂ­ obsahovat json. UkonÃ„ï¿½uji..'
              },
              pagination: {
                  sizes: 'poloÃ…Â¾ek na strÃƒÂ¡nku',
                  totalItems: 'poloÃ…Â¾ek'
              },
              grouping: {
                  group: 'Seskupit',
                  ungroup: 'Odebrat seskupenÃƒÂ­',
  ...
  angular.module('ui.grid').config(['$provide', function($provide) {
    $provide.decorator('i18nService', ['$delegate', function($delegate) {
      $delegate.add('da', {
        ...
        groupPanel:{
          description: 'GrupÃƒÂ©r rÃƒÂ¦kker udfra en kolonne ved at trÃƒÂ¦kke dens overskift hertil.'
        },
        search:{
          placeholder: 'SÃƒÂ¸g...',
          showingItems: 'Viste rÃƒÂ¦kker:',
          selectedItems: 'Valgte rÃƒÂ¦kker:',
          totalItems: 'RÃƒÂ¦kker totalt:',
          size: 'Side stÃƒÂ¸rrelse:',
          first: 'FÃƒÂ¸rste side',
          next: 'NÃƒÂ¦ste side',
          previous: 'Forrige side',
          last: 'Sidste side'
        },
        menu:{
          text: 'VÃƒÂ¦lg kolonner:'
        },
        column: {
          hide: 'Skjul kolonne'
        },
        aggregation: {
          count: 'samlede rÃƒÂ¦kker: ',
          sum: 'smalede: ',
          avg: 'gns: ',
          min: 'min: ',
          max: 'max: '
  ...
  angular.module('ui.grid').config(['$provide', function ($provide) {
    $provide.decorator('i18nService', ['$delegate', function ($delegate) {
      $delegate.add('de', {
        ...
        groupPanel: {
          description: 'Ziehen Sie eine SpaltenÃƒÂ¼berschrift hierhin, um nach dieser Spalte zu gruppieren.'
        },
        search: {
          placeholder: 'Suche...',
          showingItems: 'Zeige EintrÃƒÂ¤ge:',
          selectedItems: 'AusgewÃƒÂ¤hlte EintrÃƒÂ¤ge:',
          totalItems: 'EintrÃƒÂ¤ge gesamt:',
          size: 'EintrÃƒÂ¤ge pro Seite:',
          first: 'Erste Seite',
          next: 'NÃƒÂ¤chste Seite',
          previous: 'Vorherige Seite',
          last: 'Letzte Seite'
        },
        menu: {
          text: 'Spalten auswÃƒÂ¤hlen:'
        },
        sort: {
          ascending: 'aufsteigend sortieren',
          descending: 'absteigend sortieren',
          remove: 'Sortierung zurÃƒÂ¼cksetzen'
        },
        column: {
        ...
        importer: {
          ...
          noObjects: 'Es konnten keine Zeileninformationen gelesen werden, Sind in der Datei auÃƒÅ¸er den Spaltendefinitionen auch Daten enthalten?',
          invalidCsv: 'Die Datei konnte nicht eingelesen werden, ist es eine gÃƒÂ¼ltige CSV-Datei?',
          invalidJson: 'Die Datei konnte nicht eingelesen werden. EnthÃƒÂ¤lt sie gÃƒÂ¼ltiges JSON?',
          jsonNotArray: 'Die importierte JSON-Datei muÃƒÅ¸ ein Array enthalten. Breche Import ab.'
        },
        pagination: {
            sizes: 'EintrÃƒÂ¤ge pro Seite',
            totalItems: 'EintrÃƒÂ¤ge'
        },
        grouping: {
            group: 'Gruppieren',
  ...
  angular.module('ui.grid').config(['$provide', function($provide) {
    $provide.decorator('i18nService', ['$delegate', function($delegate) {
      $delegate.add('es', {
        ...
        groupPanel: {
          description: 'Arrastre un encabezado de columna aquÃƒÂ­ y suÃƒÂ©ltelo para agrupar por esa columna.'
        },
        search: {
          placeholder: 'Buscar...',
          showingItems: 'ArtÃƒÂ­culos Mostrados:',
          selectedItems: 'ArtÃƒÂ­culos Seleccionados:',
          totalItems: 'ArtÃƒÂ­culos Totales:',
          size: 'TamaÃƒÂ±o de PÃƒÂ¡gina:',
          first: 'Primera PÃƒÂ¡gina',
          next: 'PÃƒÂ¡gina Siguiente',
          previous: 'PÃƒÂ¡gina Anterior',
          last: 'ÃƒÅ¡ltima PÃƒÂ¡gina'
        },
        menu: {
        ...
        gridMenu: {
          ...
          exporterSelectedAsCsv: 'Exportar selecciÃƒÂ³n como csv',
          exporterAllAsPdf: 'Exportar todo como pdf',
          exporterVisibleAsPdf: 'Exportar vista como pdf',
          exporterSelectedAsPdf: 'Exportar selecciÃƒÂ³n como pdf'
        },
        importer: {
          noHeaders: 'No fue posible derivar los nombres de las columnas, Ã‚Â¿tiene encabezados el archivo?',
          noObjects: 'No fue posible obtener registros, Ã‚Â¿contiene datos el archivo, aparte de los encabezados?',
          invalidCsv: 'No fue posible procesar el archivo, Ã‚Â¿es un CSV vÃƒÂ¡lido?',
          invalidJson: 'No fue posible procesar el archivo, Ã‚Â¿es un Json vÃƒÂ¡lido?',
...
(function () {
  angular.module('ui.grid').config(['$provide', function($provide) {
    $provide.decorator('i18nService', ['$delegate', function($delegate) {
      $delegate.add('fa', {
        aggregate: {
          label: 'Ã™â€¦Ã™Ë†Ã˜Â±Ã˜Â¯Ã™â€¡Ã˜Â§'
        },
        groupPanel: {
          description: 'Ã›Å’ÃšÂ© Ã˜Â¹Ã™â€ Ã™Ë†Ã˜Â§Ã™â€  Ã˜Â³Ã˜ÂªÃ™Ë†Ã™â€  Ã˜Â§Ã›Å’Ã™â€ Ã˜Â¬Ã˜Â§ Ã˜Â±Ã˜Â§ Ã˜Â¨Ã˜Â±Ã˜Â¯Ã˜Â§Ã˜Â± Ã™Ë† Ã˜Â¨Ã™â€¡ ÃšÂ¯Ã˜Â±Ã™Ë†Ã™â€¡Ã›Å’ Ã˜Â§Ã˜Â² Ã˜Â¢Ã™â€  Ã˜Â³Ã˜ÂªÃ™Ë†Ã™â€  Ã˜Â¨Ã›Å’Ã˜Â§Ã™â€ Ã˜Â¯Ã˜Â§Ã˜Â².'
        },
        search: {
          placeholder: 'Ã˜Â¬Ã˜Â³Ã˜ÂªÃ˜Â¬Ã™Ë†...',
          showingItems: 'Ã™â€ Ã™â€¦Ã˜Â§Ã›Å’Ã˜Â´ Ã™â€¦Ã™Ë†Ã˜Â±Ã˜Â¯Ã™â€¡Ã˜Â§:',
          selectedItems: 'Ã™â€¦Ã™Ë†Ã˜Â±Ã˜Â¯Ã™â€¡Ã˜Â§Ã›Å’ Ã˜Â§Ã™â€ Ã˜ÂªÃ˜Â®Ã˜Â§Ã˜Â¨\u200cÃ˜Â´Ã˜Â¯Ã™â€¡:',
          totalItems: 'Ã™â€¡Ã™â€¦Ã™â€¡Ã™â€� Ã™â€¦Ã™Ë†Ã˜Â±Ã˜Â¯Ã™â€¡Ã˜Â§:',
          size: 'Ã˜Â§Ã™â€ Ã˜Â¯Ã˜Â§Ã˜Â²Ã™â€¡Ã™â€� Ã˜ÂµÃ™ï¿½Ã˜Â­Ã™â€¡:',
          first: 'Ã˜ÂµÃ™ï¿½Ã˜Â­Ã™â€¡Ã™â€� Ã˜Â§Ã™Ë†Ã™â€ž',
          next: 'Ã˜ÂµÃ™ï¿½Ã˜Â­Ã™â€¡Ã™â€� Ã˜Â¨Ã˜Â¹Ã˜Â¯',
          previous: 'Ã˜ÂµÃ™ï¿½Ã˜Â­Ã™â€¡Ã™â€� Ã™â€šÃ˜Â¨Ã™â€ž',
          last: 'Ã˜Â¢Ã˜Â®Ã˜Â±Ã›Å’Ã™â€  Ã˜ÂµÃ™ï¿½Ã˜Â­Ã™â€¡'
        },
        menu: {
          text: 'Ã˜Â§Ã™â€ Ã˜ÂªÃ˜Â®Ã˜Â§Ã˜Â¨ Ã˜Â³Ã˜ÂªÃ™Ë†Ã™â€ \u200cÃ™â€¡Ã˜Â§:'
        },
        column: {
          hide: 'Ã˜Â³Ã˜ÂªÃ™Ë†Ã™â€  Ã™Â¾Ã™â€ Ã™â€¡Ã˜Â§Ã™â€  ÃšÂ©Ã™â€ '
        },
        aggregation: {
          count: 'total rows: ',
          sum: 'total: ',
  ...
  angular.module('ui.grid').config(['$provide', function($provide) {
    $provide.decorator('i18nService', ['$delegate', function($delegate) {
      $delegate.add('fi', {
        ...
        groupPanel: {
          description: 'Raahaa ja pudota otsikko tÃƒÂ¤hÃƒÂ¤n ryhmittÃƒÂ¤ÃƒÂ¤ksesi sarakkeen mukaan.'
        },
        search: {
          placeholder: 'Hae...',
          showingItems: 'NÃƒÂ¤ytetÃƒÂ¤ÃƒÂ¤n rivejÃƒÂ¤:',
          selectedItems: 'Valitut rivit:',
          totalItems: 'RivejÃƒÂ¤ yht.:',
          size: 'NÃƒÂ¤ytÃƒÂ¤:',
          first: 'EnsimmÃƒÂ¤inen sivu',
          next: 'Seuraava sivu',
        ...
        sort: {
          ascending: 'JÃƒÂ¤rjestÃƒÂ¤ nouseva',
          descending: 'JÃƒÂ¤rjestÃƒÂ¤ laskeva',
          remove: 'Poista jÃƒÂ¤rjestys'
        },
        column: {
          hide: 'Piilota sarake'
        },
        ...
        gridMenu: {
          ...
          exporterVisibleAsCsv: 'Vie nÃƒÂ¤kyvÃƒÂ¤ tieto csv-muodossa',
          exporterSelectedAsCsv: 'Vie valittu tieto csv-muodossa',
          exporterAllAsPdf: 'Vie tiedot pdf-muodossa',
          exporterVisibleAsPdf: 'Vie nÃƒÂ¤kyvÃƒÂ¤ tieto pdf-muodossa',
          exporterSelectedAsPdf: 'Vie valittu tieto pdf-muodossa'
        },
        importer: {
          noHeaders: 'Sarakkeen nimiÃƒÂ¤ ei voitu pÃƒÂ¤ÃƒÂ¤tellÃƒÂ¤, onko tiedostossa otsikkoriviÃƒÂ¤?',
          noObjects: 'Tietoja ei voitu lukea, onko tiedostossa muuta kuin otsikkot?',
          invalidCsv: 'Tiedostoa ei voitu kÃƒÂ¤sitellÃƒÂ¤, oliko se CSV-muodossa?',
          invalidJson: 'Tiedostoa ei voitu kÃƒÂ¤sitellÃƒÂ¤, oliko se JSON-muodossa?',
          jsonNotArray: 'Tiedosto ei sisÃƒÂ¤ltÃƒÂ¤nyt taulukkoa, lopetetaan.'
        }
      });
      return $delegate;
    }]);
...
(function () {
  angular.module('ui.grid').config(['$provide', function($provide) {
    $provide.decorator('i18nService', ['$delegate', function($delegate) {
      $delegate.add('fr', {
        aggregate: {
          label: 'ÃƒÂ©lÃƒÂ©ments'
        },
        groupPanel: {
          description: 'Faites glisser une en-tÃƒÂªte de colonne ici pour crÃƒÂ©er un groupe de colonnes.'
        },
        search: {
          placeholder: 'Recherche...',
          showingItems: 'Affichage des ÃƒÂ©lÃƒÂ©ments :',
          selectedItems: 'Ãƒâ€°lÃƒÂ©ments sÃƒÂ©lectionnÃƒÂ©s :',
          totalItems: 'Nombre total d\'ÃƒÂ©lÃƒÂ©ments:',
          size: 'Taille de page:',
          first: 'PremiÃƒÂ¨re page',
          next: 'Page Suivante',
          previous: 'Page prÃƒÂ©cÃƒÂ©dente',
          last: 'DerniÃƒÂ¨re page'
        },
        menu: {
        ...
        sort: {
          ...
          descending: 'Trier par ordre dÃƒÂ©croissant',
        ...
        pinning: {
          pinLeft: 'Ãƒâ€°pingler ÃƒÂ  gauche',
          pinRight: 'Ãƒâ€°pingler ÃƒÂ  droite',
          unpin: 'DÃƒÂ©tacher'
        },
        gridMenu: {
          columns: 'Colonnes:',
          importerTitle: 'Importer un fichier',
          exporterAllAsCsv: 'Exporter toutes les donnÃƒÂ©es en CSV',
          exporterVisibleAsCsv: 'Exporter les donnÃƒÂ©es visibles en CSV',
          exporterSelectedAsCsv: 'Exporter les donnÃƒÂ©es sÃƒÂ©lectionnÃƒÂ©es en CSV',
          exporterAllAsPdf: 'Exporter toutes les donnÃƒÂ©es en PDF',
          exporterVisibleAsPdf: 'Exporter les donnÃƒÂ©es visibles en PDF',
          exporterSelectedAsPdf: 'Exporter les donnÃƒÂ©es sÃƒÂ©lectionnÃƒÂ©es en PDF'
        },
        importer: {
          noHeaders: 'Impossible de dÃƒÂ©terminer le nom des colonnes, le fichier possÃƒÂ¨de-t-il une en-tÃƒÂªte ?',
          noObjects: 'Aucun objet trouvÃƒÂ©, le fichier possÃƒÂ¨de-t-il des donnÃƒÂ©es autres que l\'en-tÃƒÂªte ?',
          invalidCsv: 'Le fichier n\'a pas pu ÃƒÂªtre traitÃƒÂ©, le CSV est-il valide ?',
          invalidJson: 'Le fichier n\'a pas pu ÃƒÂªtre traitÃƒÂ©, le JSON est-il valide ?',
          jsonNotArray: 'Le fichier JSON importÃƒÂ© doit contenir un tableau, abandon.'
        },
        pagination: {
          sizes: 'ÃƒÂ©lÃƒÂ©ments par page',
          totalItems: 'ÃƒÂ©lÃƒÂ©ments'
        },
        grouping: {
          group: 'Grouper',
          ungroup: 'DÃƒÂ©grouper',
  ...
  angular.module('ui.grid').config(['$provide', function ($provide) {
    $provide.decorator('i18nService', ['$delegate', function ($delegate) {
      $delegate.add('he', {
        ...
        groupPanel: {
          description: 'Ã—â€™Ã—Â¨Ã—â€¢Ã—Â¨ Ã—Â¢Ã—Å¾Ã—â€¢Ã—â€œÃ—â€� Ã—Å“Ã—â€ºÃ—ï¿½Ã—Å¸ Ã—â€¢Ã—Â©Ã—â€”Ã—Â¨Ã—Â¨ Ã—â€˜Ã—â€ºÃ—â€œÃ—â„¢ Ã—Å“Ã—Â§Ã—â€˜Ã—Â¥ Ã—Â¢Ã—Å¾Ã—â€¢Ã—â€œÃ—â€� Ã—â€“Ã—â€¢.'
        },
        search: {
          placeholder: 'Ã—â€”Ã—Â¤Ã—Â©...',
          showingItems: 'Ã—Å¾Ã—Â¦Ã—â„¢Ã—â€™:',
          selectedItems: 'Ã—Â¡Ã—â€�"Ã—â€º Ã—Â Ã—â€˜Ã—â€”Ã—Â¨Ã—â€¢:',
          totalItems: 'Ã—Â¡Ã—â€�"Ã—â€º Ã—Â¨Ã—Â©Ã—â€¢Ã—Å¾Ã—â€¢Ã—Âª:',
          size: 'Ã—ÂªÃ—â€¢Ã—Â¦Ã—ï¿½Ã—â€¢Ã—Âª Ã—â€˜Ã—â€œÃ—Â£:',
          first: 'Ã—â€œÃ—Â£ Ã—Â¨Ã—ï¿½Ã—Â©Ã—â€¢Ã—Å¸',
          next: 'Ã—â€œÃ—Â£ Ã—â€�Ã—â€˜Ã—ï¿½',
          previous: 'Ã—â€œÃ—Â£ Ã—Â§Ã—â€¢Ã—â€œÃ—ï¿½',
          last: 'Ã—â€œÃ—Â£ Ã—ï¿½Ã—â€”Ã—Â¨Ã—â€¢Ã—Å¸'
        },
        menu: {
          text: 'Ã—â€˜Ã—â€”Ã—Â¨ Ã—Â¢Ã—Å¾Ã—â€¢Ã—â€œÃ—â€¢Ã—Âª:'
        },
        sort: {
          ascending: 'Ã—Â¡Ã—â€œÃ—Â¨ Ã—Â¢Ã—â€¢Ã—Å“Ã—â€�',
          descending: 'Ã—Â¡Ã—â€œÃ—Â¨ Ã—â„¢Ã—â€¢Ã—Â¨Ã—â€œ',
          remove: 'Ã—â€˜Ã—ËœÃ—Å“'
        },
        column: {
          hide: 'Ã—ËœÃ—â€¢Ã—Â¨ Ã—â€�Ã—Â¡Ã—ÂªÃ—Â¨'
        },
        aggregation: {
          count: 'total rows: ',
          sum: 'total: ',
...
(function () {
  angular.module('ui.grid').config(['$provide', function($provide) {
    $provide.decorator('i18nService', ['$delegate', function($delegate) {
      $delegate.add('hy', {
        aggregate: {
          label: 'Ã•Â¿Ã•Â¾Ã•ÂµÃ•Â¡Ã•Â¬Ã•Â¶Ã•Â¥Ã–â‚¬'
        },
        groupPanel: {
          description: 'Ã”Â¸Ã•Â½Ã•Â¿ Ã•Â½Ã•ÂµÃ•Â¡Ã•Â¶ Ã•Â­Ã•Â´Ã•Â¢Ã•Â¡Ã•Â¾Ã•Â¸Ã–â‚¬Ã•Â¥Ã•Â¬Ã•Â¸Ã–â€š Ã•Â°Ã•Â¡Ã•Â´Ã•Â¡Ã–â‚¬ Ã–â€žÃ•Â¡Ã•Â·Ã•Â¥Ã–â€ž Ã–â€¡ Ã•Â£Ã–ï¿½Ã•Â¥Ã–â€ž Ã•Â¾Ã•Â¥Ã–â‚¬Ã•Â¶Ã•Â¡Ã•Â£Ã•Â«Ã–â‚¬Ã•Â¶ Ã•Â¡Ã•ÂµÃ•Â½Ã•Â¿Ã•Â¥Ã•Â²Ã–â€°'
        },
        search: {
          placeholder: 'Ã•â€œÃ•Â¶Ã•Â¿Ã–â‚¬Ã•Â¸Ã–â€šÃ•Â´...',
          showingItems: 'Ã•â€˜Ã•Â¸Ã–â€šÃ–ï¿½Ã•Â¡Ã•Â¤Ã–â‚¬Ã•Â¾Ã•Â¡Ã•Â® Ã•Â¿Ã•Â¾Ã•ÂµÃ•Â¡Ã•Â¬Ã•Â¶Ã•Â¥Ã–â‚¬Ã•ï¿½',
          selectedItems: 'Ã”Â¸Ã•Â¶Ã•Â¿Ã–â‚¬Ã•Â¾Ã•Â¡Ã•Â®:',
          totalItems: 'Ã”Â¸Ã•Â¶Ã•Â¤Ã•Â¡Ã•Â´Ã•Â¥Ã•Â¶Ã•Â¨Ã•ï¿½',
          size: 'Ã•ï¿½Ã•Â¸Ã•Â²Ã•Â¥Ã–â‚¬Ã•Â« Ã–â€žÃ•Â¡Ã•Â¶Ã•Â¡Ã•Â¯Ã•Â¨ Ã•Â§Ã•Â»Ã•Â¸Ã–â€šÃ•Â´Ã•ï¿½',
          first: 'Ã”Â±Ã•Â¼Ã•Â¡Ã•Â»Ã•Â«Ã•Â¶ Ã•Â§Ã•Â»',
          next: 'Ã•â‚¬Ã•Â¡Ã•Â»Ã•Â¸Ã–â‚¬Ã•Â¤ Ã•Â§Ã•Â»',
          previous: 'Ã•â€ Ã•Â¡Ã•Â­Ã•Â¸Ã–â‚¬Ã•Â¤ Ã•Â§Ã•Â»',
          last: 'Ã•Å½Ã•Â¥Ã–â‚¬Ã•Â»Ã•Â«Ã•Â¶ Ã•Â§Ã•Â»'
        },
        menu: {
          text: 'Ã”Â¸Ã•Â¶Ã•Â¿Ã–â‚¬Ã•Â¥Ã•Â¬ Ã•Â½Ã•ÂµÃ•Â¸Ã–â€šÃ•Â¶Ã•Â¥Ã–â‚¬Ã•Â¨:'
        },
        sort: {
          ascending: 'Ã”Â±Ã•Â³Ã•Â´Ã•Â¡Ã•Â¶ Ã•Â¯Ã•Â¡Ã–â‚¬Ã•Â£Ã•Â¸Ã•Â¾',
          descending: 'Ã•â€ Ã•Â¾Ã•Â¡Ã•Â¦Ã•Â´Ã•Â¡Ã•Â¶ Ã•Â¯Ã•Â¡Ã–â‚¬Ã•Â£Ã•Â¸Ã•Â¾',
          remove: 'Ã•â‚¬Ã•Â¡Ã•Â¶Ã•Â¥Ã•Â¬ '
        },
        column: {
          hide: 'Ã”Â¹Ã•Â¡Ã–â€žÃ–ï¿½Ã•Â¶Ã•Â¥Ã•Â¬ Ã•Â½Ã•ÂµÃ•Â¸Ã–â€šÃ•Â¶Ã•Â¨'
        },
        aggregation: {
          count: 'Ã•Â¨Ã•Â¶Ã•Â¤Ã•Â¡Ã•Â´Ã•Â¥Ã•Â¶Ã•Â¨ Ã•Â¿Ã•Â¸Ã•Â²Ã•ï¿½ ',
          sum: 'Ã•Â¨Ã•Â¶Ã•Â¤Ã•Â¡Ã•Â´Ã•Â¥Ã•Â¶Ã•Â¨Ã•ï¿½ ',
          avg: 'Ã•Â´Ã•Â«Ã•Â»Ã•Â«Ã•Â¶Ã•ï¿½ ',
          min: 'Ã•Â´Ã•Â«Ã•Â¶Ã•ï¿½ ',
          max: 'Ã•Â´Ã•Â¡Ã–â€žÃ•Â½Ã•ï¿½ '
        },
        pinning: {
          pinLeft: 'Ã”Â¿Ã•ÂºÃ–ï¿½Ã•Â¶Ã•Â¥Ã•Â¬ Ã•Â±Ã•Â¡Ã•Â­ Ã•Â¯Ã•Â¸Ã•Â²Ã•Â´Ã•Â¸Ã–â€šÃ•Â´',
          pinRight: 'Ã”Â¿Ã•ÂºÃ–ï¿½Ã•Â¶Ã•Â¥Ã•Â¬ Ã•Â¡Ã•Â» Ã•Â¯Ã•Â¸Ã•Â²Ã•Â´Ã•Â¸Ã–â€šÃ•Â´',
          unpin: 'Ã”Â±Ã–â‚¬Ã•Â±Ã•Â¡Ã•Â¯Ã•Â¥Ã•Â¬'
        },
        gridMenu: {
          columns: 'Ã•ï¿½Ã•ÂµÃ•Â¸Ã–â€šÃ•Â¶Ã•Â¥Ã–â‚¬:',
          importerTitle: 'Ã•â€ Ã•Â¥Ã–â‚¬Ã•Â´Ã•Â¸Ã–â€šÃ•Â®Ã•Â¥Ã•Â¬ Ã–â€ Ã•Â¡Ã•ÂµÃ•Â¬',
          exporterAllAsCsv: 'Ã”Â±Ã–â‚¬Ã•Â¿Ã•Â¡Ã•Â°Ã•Â¡Ã•Â¶Ã•Â¥Ã•Â¬ Ã•Â¡Ã•Â´Ã•Â¢Ã•Â¸Ã•Â²Ã•Â»Ã•Â¨ CSV',
          exporterVisibleAsCsv: 'Ã”Â±Ã–â‚¬Ã•Â¿Ã•Â¡Ã•Â°Ã•Â¡Ã•Â¶Ã•Â¥Ã•Â¬ Ã•Â¥Ã–â‚¬Ã–â€¡Ã•Â¡Ã–ï¿½Ã•Â¸Ã•Â² Ã•Â¿Ã•Â¾Ã•ÂµÃ•Â¡Ã•Â¬Ã•Â¶Ã•Â¥Ã–â‚¬Ã•Â¨ CSV',
          exporterSelectedAsCsv: 'Ã”Â±Ã–â‚¬Ã•Â¿Ã•Â¡Ã•Â°Ã•Â¡Ã•Â¶Ã•Â¥Ã•Â¬ Ã•Â¨Ã•Â¶Ã•Â¿Ã–â‚¬Ã•Â¾Ã•Â¡Ã•Â® Ã•Â¿Ã•Â¾Ã•ÂµÃ•Â¡Ã•Â¬Ã•Â¶Ã•Â¥Ã–â‚¬Ã•Â¨ CSV',
          exporterAllAsPdf: 'Ã”Â±Ã–â‚¬Ã•Â¿Ã•Â¡Ã•Â°Ã•Â¡Ã•Â¶Ã•Â¥Ã•Â¬ PDF',
          exporterVisibleAsPdf: 'Ã”Â±Ã–â‚¬Ã•Â¿Ã•Â¡Ã•Â°Ã•Â¡Ã•Â¶Ã•Â¥Ã•Â¬ Ã•Â¥Ã–â‚¬Ã–â€¡Ã•Â¡Ã–ï¿½Ã•Â¸Ã•Â² Ã•Â¿Ã•Â¾Ã•ÂµÃ•Â¡Ã•Â¬Ã•Â¶Ã•Â¥Ã–â‚¬Ã•Â¨ PDF',
          exporterSelectedAsPdf: 'Ã”Â±Ã–â‚¬Ã•Â¿Ã•Â¡Ã•Â°Ã•Â¡Ã•Â¶Ã•Â¥Ã•Â¬ Ã•Â¨Ã•Â¶Ã•Â¿Ã–â‚¬Ã•Â¾Ã•Â¡Ã•Â® Ã•Â¿Ã•Â¾Ã•ÂµÃ•Â¡Ã•Â¬Ã•Â¶Ã•Â¥Ã–â‚¬Ã•Â¨ PDF'
        },
        importer: {
          noHeaders: 'Ã•â‚¬Ã•Â¶Ã•Â¡Ã–â‚¬Ã•Â¡Ã•Â¾Ã•Â¸Ã–â‚¬ Ã•Â¹Ã•Â¥Ã•Â²Ã•Â¡Ã•Â¾ Ã•Â¸Ã–â‚¬Ã•Â¸Ã•Â·Ã•Â¥Ã•Â¬ Ã•Â½Ã•ÂµÃ•Â¡Ã•Â¶ Ã•Â¾Ã•Â¥Ã–â‚¬Ã•Â¶Ã•Â¡Ã•Â£Ã–â‚¬Ã•Â¥Ã–â‚¬Ã•Â¨Ã–â€° Ã”Â±Ã–â‚¬Ã•Â¤Ã•ÂµÃ•Â¸Ã•Å¾Ã–â€ž Ã–â€ Ã•Â¡Ã•ÂµÃ•Â¬Ã•Â¨ Ã•Â¸Ã–â€šÃ•Â¶Ã•Â« Ã•Â¾Ã•Â¥Ã–â‚¬Ã•Â¶Ã•Â¡Ã•Â£Ã–â‚¬Ã•Â¥Ã–â‚¬Ã–â€°',
          noObjects: 'Ã•â‚¬Ã•Â¶Ã•Â¡Ã–â‚¬Ã•Â¡Ã•Â¾Ã•Â¸Ã–â‚¬ Ã•Â¹Ã•Â¥Ã•Â²Ã•Â¡Ã•Â¾ Ã•Â¯Ã•Â¡Ã–â‚¬Ã•Â¤Ã•Â¡Ã•Â¬ Ã•Â¿Ã•Â¾Ã•ÂµÃ•Â¡Ã•Â¬Ã•Â¶Ã•Â¥Ã–â‚¬Ã•Â¨Ã–â€° Ã”Â±Ã–â‚¬Ã•Â¤Ã•ÂµÃ•Â¸Ã•Å¾Ã–â€ž Ã–â€ Ã•Â¡Ã•ÂµÃ•Â¬Ã•Â¸Ã–â€šÃ•Â´ Ã•Â¯Ã•Â¡Ã•Â¶ Ã•Â¿Ã•Â¾Ã•ÂµÃ•Â¡Ã•Â¬Ã•Â¶Ã•Â¥Ã–â‚¬Ã–â€°',
          invalidCsv: 'Ã•â‚¬Ã•Â¶Ã•Â¡Ã–â‚¬Ã•Â¡Ã•Â¾Ã•Â¸Ã–â‚¬ Ã•Â¹Ã•Â¥Ã•Â²Ã•Â¡Ã•Â¾ Ã•Â´Ã•Â·Ã•Â¡Ã•Â¯Ã•Â¥Ã•Â¬ Ã–â€ Ã•Â¡Ã•ÂµÃ•Â¬Ã•Â¨Ã–â€° Ã”Â±Ã–â‚¬Ã•Â¤Ã•ÂµÃ•Â¸Ã•Å¾Ã–â€ž Ã•Â¡Ã•ÂµÃ•Â¶ Ã•Â¾Ã•Â¡Ã•Â¾Ã•Â¥Ã–â‚¬ CSV Ã•Â§Ã–â€°',
          invalidJson: 'Ã•â‚¬Ã•Â¶Ã•Â¡Ã–â‚¬Ã•Â¡Ã•Â¾Ã•Â¸Ã–â‚¬ Ã•Â¹Ã•Â¥Ã•Â²Ã•Â¡Ã•Â¾ Ã•Â´Ã•Â·Ã•Â¡Ã•Â¯Ã•Â¥Ã•Â¬ Ã–â€ Ã•Â¡Ã•ÂµÃ•Â¬Ã•Â¨Ã–â€° Ã”Â±Ã–â‚¬Ã•Â¤Ã•ÂµÃ•Â¸Ã•Å¾Ã–â€ž Ã•Â¡Ã•ÂµÃ•Â¶ Ã•Â¾Ã•Â¡Ã•Â¾Ã•Â¥Ã–â‚¬ Json Ã•Â§Ã–â€°',
          jsonNotArray: 'Ã•â€ Ã•Â¥Ã–â‚¬Ã•Â´Ã•Â¸Ã–â€šÃ•Â®Ã•Â¾Ã•Â¡Ã•Â® json Ã–â€ Ã•Â¡Ã•ÂµÃ•Â¬Ã•Â¨ Ã•ÂºÃ•Â¥Ã•Â¿Ã–â€ž Ã•Â§ Ã•ÂºÃ•Â¡Ã–â‚¬Ã•Â¸Ã–â€šÃ•Â¶Ã•Â¡Ã•Â¯Ã•Â« Ã•Â¦Ã•Â¡Ã•Â¶Ã•Â£Ã•Â¾Ã•Â¡Ã•Â®, Ã•Â¯Ã•Â¡Ã•Â½Ã•Â¥Ã–ï¿½Ã•Â¾Ã•Â¸Ã–â€šÃ•Â´ Ã•Â§Ã–â€°'
        }
      });
      return $delegate;
    }]);
  ...
  angular.module('ui.grid').config(['$provide', function($provide) {
    $provide.decorator('i18nService', ['$delegate', function($delegate) {
      $delegate.add('ja', {
        ...
        groupPanel: {
          description: 'Ã¥Ë†â€”Ã¥ï¿½ï¿½Ã©Æ’Â¨Ã¥Ë†â€ Ã£â€šâ€™Ã£ï¿½â€œÃ£ï¿½â€œÃ£ï¿½Â«Ã£Æ’â€°Ã£Æ’Â©Ã£Æ’Æ’Ã£â€šÂ°Ã£â€šÂ¢Ã£Æ’Â³Ã£Æ’â€°Ã£Æ’â€°Ã£Æ’Â­Ã£Æ’Æ’Ã£Æ’â€”Ã£ï¿½â„¢Ã£â€šâ€¹Ã£ï¿½â€œÃ£ï¿½Â¨Ã£ï¿½Â§Ã¥Ë†â€”Ã£ï¿½â€�Ã£ï¿½Â¨Ã£ï¿½Â«Ã£â€šÂ°Ã£Æ’Â«Ã£Æ’Â¼Ã£Æ’â€”Ã¥Ë†â€ Ã£ï¿½â€˜Ã£â€šâ€™Ã¨Â¡Å’Ã£ï¿½â€ Ã£ï¿½â€œÃ£ï¿½Â¨Ã£ï¿½Å’Ã£ï¿½Â§Ã£ï¿½ï¿½Ã£ï¿½Â¾Ã£ï¿½â„¢Ã£â‚¬â€š'
        },
        search: {
          placeholder: 'Ã¦Â¤Å“Ã§Â´Â¢...',
          showingItems: 'Ã§ÂµÅ¾Ã¨Â¾Â¼Ã£ï¿½Â¿Ã¤Â»Â¶Ã¦â€¢Â°:',
          selectedItems: 'Ã©ï¿½Â¸Ã¦Å Å¾Ã¤Â»Â¶Ã¦â€¢Â°:',
          totalItems: 'Ã¥â€¦Â¨Ã¤Â»Â¶Ã¦â€¢Â°:',
          size: 'Ã£Æ’Å¡Ã£Æ’Â¼Ã£â€šÂ¸Ã£â€šÂµÃ£â€šÂ¤Ã£â€šÂº: ',
          first: 'Ã¦Å“â‚¬Ã¥Ë†ï¿½Ã£ï¿½Â®Ã£Æ’Å¡Ã£Æ’Â¼Ã£â€šÂ¸',
          next: 'Ã¦Â¬Â¡Ã£ï¿½Â®Ã£Æ’Å¡Ã£Æ’Â¼Ã£â€šÂ¸',
          previous: 'Ã¥â€°ï¿½Ã£ï¿½Â®Ã£Æ’Å¡Ã£Æ’Â¼Ã£â€šÂ¸',
          last: 'Ã¦Å“â‚¬Ã¥Â¾Å’Ã£ï¿½Â®Ã£Æ’Å¡Ã£Æ’Â¼Ã£â€šÂ¸'
        },
        menu: {
          text: 'Ã¥Ë†â€”Ã©ï¿½Â¸Ã¦Å Å¾:'
        },
        sort: {
          ascending: 'Ã¦Ëœâ€¡Ã©Â â€ Ã£â€šÂ½Ã£Æ’Â¼Ã£Æ’Ë†',
          descending: 'Ã©â„¢ï¿½Ã©Â â€ Ã£â€šÂ½Ã£Æ’Â¼Ã£Æ’Ë†',
          remove: 'Ã£â€šÂ½Ã£Æ’Â¼Ã£Æ’Ë†Ã¥ï¿½â€“Ã¦Â¶Ë†'
        },
        column: {
          hide: 'Ã¥Ë†â€”Ã£â€šâ€™Ã©Å¡Â Ã£ï¿½â„¢'
        },
        aggregation: {
          count: 'Ã¥ï¿½Ë†Ã¨Â¨Ë†Ã¤Â»Â¶Ã¦â€¢Â°: ',
          sum: 'Ã¥ï¿½Ë†Ã¨Â¨Ë†: ',
          avg: 'Ã¥Â¹Â³Ã¥ï¿½â€¡: ',
          min: 'Ã¦Å“â‚¬Ã¥Â°ï¿½Ã¥â‚¬Â¤: ',
          max: 'Ã¦Å“â‚¬Ã¥Â¤Â§Ã¥â‚¬Â¤: '
        },
        pinning: {
          pinLeft: 'Ã¥Â·Â¦Ã£ï¿½Â«Ã£Æ’â€�Ã£Æ’Â³Ã§â€¢â„¢Ã£â€šï¿½',
          pinRight: 'Ã¥ï¿½Â³Ã£ï¿½Â«Ã£Æ’â€�Ã£Æ’Â³Ã§â€¢â„¢Ã£â€šï¿½',
          unpin: 'Ã£Æ’â€�Ã£Æ’Â³Ã§â€¢â„¢Ã£â€šï¿½Ã¥ï¿½â€“Ã¦Â¶Ë†'
        },
        gridMenu: {
          columns: 'Ã¥Ë†â€”:',
          importerTitle: 'Ã£â€šÂ¤Ã£Æ’Â³Ã£Æ’ï¿½Ã£Æ’Â¼Ã£Æ’Ë†Ã£Æ’â€¢Ã£â€šÂ¡Ã£â€šÂ¤Ã£Æ’Â«',
          exporterAllAsCsv: 'Ã¥â€¦Â¨Ã£ï¿½Â¦Ã£ï¿½Â®Ã£Æ’â€¡Ã£Æ’Â¼Ã£â€šÂ¿Ã£â€šâ€™CSVÃ¥Â½Â¢Ã¥Â¼ï¿½Ã£ï¿½Â§Ã£â€šÂ¨Ã£â€šÂ¯Ã£â€šÂ¹Ã£Æ’ï¿½Ã£Æ’Â¼Ã£Æ’Ë†',
          exporterVisibleAsCsv: 'Ã§ÂµÅ¾Ã¨Â¾Â¼Ã£ï¿½Â¿Ã¦Â¸Ë†Ã£ï¿½Â¿Ã£Æ’â€¡Ã£Æ’Â¼Ã£â€šÂ¿Ã£â€šâ€™CSVÃ¥Â½Â¢Ã¥Â¼ï¿½Ã£ï¿½Â§Ã£â€šÂ¨Ã£â€šÂ¯Ã£â€šÂ¹Ã£Æ’ï¿½Ã£Æ’Â¼Ã£Æ’Ë†',
          exporterSelectedAsCsv: 'Ã©ï¿½Â¸Ã¦Å Å¾Ã£ï¿½â€”Ã£ï¿½Â¦Ã£ï¿½â€žÃ£â€šâ€¹Ã£Æ’â€¡Ã£Æ’Â¼Ã£â€šÂ¿Ã£â€šâ€™CSVÃ¥Â½Â¢Ã¥Â¼ï¿½Ã£ï¿½Â§Ã£â€šÂ¨Ã£â€šÂ¯Ã£â€šÂ¹Ã£Æ’ï¿½Ã£Æ’Â¼Ã£Æ’Ë†',
          exporterAllAsPdf: 'Ã¥â€¦Â¨Ã£ï¿½Â¦Ã£ï¿½Â®Ã£Æ’â€¡Ã£Æ’Â¼Ã£â€šÂ¿Ã£â€šâ€™PDFÃ£ï¿½Â§Ã£â€šÂ¨Ã£â€šÂ¯Ã£â€šÂ¹Ã£Æ’ï¿½Ã£Æ’Â¼Ã£Æ’Ë†',
          exporterVisibleAsPdf: 'Ã§ÂµÅ¾Ã¨Â¾Â¼Ã£ï¿½Â¿Ã¦Â¸Ë†Ã£ï¿½Â¿Ã£Æ’â€¡Ã£Æ’Â¼Ã£â€šÂ¿Ã£â€šâ€™PDFÃ£ï¿½Â§Ã£â€šÂ¨Ã£â€šÂ¯Ã£â€šÂ¹Ã£Æ’ï¿½Ã£Æ’Â¼Ã£Æ’Ë†',
          exporterSelectedAsPdf: 'Ã©ï¿½Â¸Ã¦Å Å¾Ã£ï¿½â€”Ã£ï¿½Â¦Ã£ï¿½â€žÃ£â€šâ€¹Ã£Æ’â€¡Ã£Æ’Â¼Ã£â€šÂ¿Ã£â€šâ€™PDFÃ£ï¿½Â§Ã£â€šÂ¨Ã£â€šÂ¯Ã£â€šÂ¹Ã£Æ’ï¿½Ã£Æ’Â¼Ã£Æ’Ë†'
        },
        importer: {
          noHeaders: 'Ã¥Ë†â€”Ã¥ï¿½ï¿½Ã£ï¿½Å’Ã¦Å Â½Ã¥â€¡ÂºÃ£ï¿½Â§Ã£ï¿½ï¿½Ã£ï¿½Â¾Ã£ï¿½â€ºÃ£â€šâ€œÃ£â‚¬â€šÃ£Æ’ËœÃ£Æ’Æ’Ã£Æ’â‚¬Ã£Æ’Â¼Ã£ï¿½Â¯Ã¨Â¨Â­Ã¥Â®Å¡Ã£ï¿½â€¢Ã£â€šÅ’Ã£ï¿½Â¦Ã£ï¿½â€žÃ£ï¿½Â¾Ã£ï¿½â„¢Ã£ï¿½â€¹Ã¯Â¼Å¸',
          noObjects: 'Ã£Æ’â€¡Ã£Æ’Â¼Ã£â€šÂ¿Ã£ï¿½Å’Ã¦Å Â½Ã¥â€¡ÂºÃ£ï¿½Â§Ã£ï¿½ï¿½Ã£ï¿½Â¾Ã£ï¿½â€ºÃ£â€šâ€œÃ£â‚¬â€šÃ£Æ’â€¢Ã£â€šÂ¡Ã£â€šÂ¤Ã£Æ’Â«Ã£ï¿½Â«Ã£Æ’â€¡Ã£Æ’Â¼Ã£â€šÂ¿Ã£ï¿½Â¯Ã¥ï¿½Â«Ã£ï¿½Â¾Ã£â€šÅ’Ã£ï¿½Â¦Ã£ï¿½â€žÃ£ï¿½Â¾Ã£ï¿½â„¢Ã£ï¿½â€¹Ã¯Â¼Å¸',
          invalidCsv: 'Ã¥â€¡Â¦Ã§ï¿½â€ Ã£â€šâ€™Ã¨Â¡Å’Ã£ï¿½â€ Ã£ï¿½â€œÃ£ï¿½Â¨Ã£ï¿½Å’Ã£ï¿½Â§Ã£ï¿½ï¿½Ã£ï¿½Â¾Ã£ï¿½â€ºÃ£â€šâ€œÃ£â‚¬â€šÃ£Æ’â€¢Ã£â€šÂ¡Ã£â€šÂ¤Ã£Æ’Â«Ã£ï¿½Â¯Ã¦Å“â€°Ã¥Å Â¹Ã£ï¿½ÂªCSVÃ£Æ’â€¢Ã£â€šÂ¡Ã£â€šÂ¤Ã£Æ’Â«Ã£ï¿½Â§Ã£ï¿½â„¢Ã£ï¿½â€¹Ã¯Â¼Å¸',
          invalidJson: 'Ã¥â€¡Â¦Ã§ï¿½â€ Ã£â€šâ€™Ã¨Â¡Å’Ã£ï¿½â€ Ã£ï¿½â€œÃ£ï¿½Â¨Ã£ï¿½Å’Ã£ï¿½Â§Ã£ï¿½ï¿½Ã£ï¿½Â¾Ã£ï¿½â€ºÃ£â€šâ€œÃ£â‚¬â€šÃ£Æ’â€¢Ã£â€šÂ¡Ã£â€šÂ¤Ã£Æ’Â«Ã£ï¿½Â¯Ã¦Å“â€°Ã¥Å Â¹Ã£ï¿½ÂªJSONÃ£Æ’â€¢Ã£â€šÂ¡Ã£â€šÂ¤Ã£Æ’Â«Ã£ï¿½Â§Ã£ï¿½â„¢Ã£ï¿½â€¹Ã¯Â¼Å¸',
          jsonNotArray: 'JSONÃ£Æ’â€¢Ã£â€šÂ¡Ã£â€šÂ¤Ã£Æ’Â«Ã£ï¿½Â¯Ã©â€¦ï¿½Ã¥Ë†â€”Ã£â€šâ€™Ã¥ï¿½Â«Ã£â€šâ€œÃ£ï¿½Â§Ã£ï¿½â€žÃ£â€šâ€¹Ã¥Â¿â€¦Ã¨Â¦ï¿½Ã£ï¿½Å’Ã£ï¿½â€šÃ£â€šÅ Ã£ï¿½Â¾Ã£ï¿½â„¢Ã£â‚¬â€šÃ¥â€¡Â¦Ã§ï¿½â€ Ã£â€šâ€™Ã¤Â¸Â­Ã¦â€“Â­Ã£ï¿½â€”Ã£ï¿½Â¾Ã£ï¿½â„¢Ã£â‚¬â€š'
        },
        pagination: {
          sizes: 'Ã¤Â»Â¶ / Ã£Æ’Å¡Ã£Æ’Â¼Ã£â€šÂ¸',
          totalItems: 'Ã¤Â»Â¶'
        }
      });
      return $delegate;
...
(function () {
  angular.module('ui.grid').config(['$provide', function($provide) {
    $provide.decorator('i18nService', ['$delegate', function($delegate) {
      $delegate.add('ko', {
        aggregate: {
          label: 'Ã¬â€¢â€žÃ¬ï¿½Â´Ã­â€¦Å“'
        },
        groupPanel: {
          description: 'Ã¬Â»Â¬Ã«Å¸Â¼Ã¬Å“Â¼Ã«Â¡Å“ ÃªÂ·Â¸Ã«Â£Â¹Ã­â€¢â€˜Ã­â€¢ËœÃªÂ¸Â° Ã¬Å“â€žÃ­â€¢Â´Ã¬â€žÅ“Ã«Å â€� Ã¬Â»Â¬Ã«Å¸Â¼ Ã­â€”Â¤Ã«ï¿½â€�Ã«Â¥Â¼ Ã«ï¿½Å’Ã¬â€“Â´ Ã«â€“Â¨Ã¬â€“Â´Ã«Å“Â¨Ã«Â Â¤ Ã¬Â£Â¼Ã¬â€žÂ¸Ã¬Å¡â€�.'
        },
        search: {
          placeholder: 'ÃªÂ²â‚¬Ã¬Æ’â€°...',
          showingItems: 'Ã­â€¢Â­Ã«ÂªÂ© Ã«Â³Â´Ã¬â€”Â¬Ã¬Â£Â¼ÃªÂ¸Â°:',
          selectedItems: 'Ã¬â€žÂ Ã­Æ’ï¿½ Ã­â€¢Â­Ã«ÂªÂ©:',
          totalItems: 'Ã¬Â â€žÃ¬Â²Â´ Ã­â€¢Â­Ã«ÂªÂ©:',
          size: 'Ã­Å½ËœÃ¬ï¿½Â´Ã¬Â§â‚¬ Ã­ï¿½Â¬ÃªÂ¸Â°:',
          first: 'Ã¬Â²Â«Ã«Â²Ë†Ã¬Â§Â¸ Ã­Å½ËœÃ¬ï¿½Â´Ã¬Â§â‚¬',
          next: 'Ã«â€¹Â¤Ã¬ï¿½Å’ Ã­Å½ËœÃ¬ï¿½Â´Ã¬Â§â‚¬',
          previous: 'Ã¬ï¿½Â´Ã¬Â â€ž Ã­Å½ËœÃ¬ï¿½Â´Ã¬Â§â‚¬',
          last: 'Ã«Â§Ë†Ã¬Â§â‚¬Ã«Â§â€° Ã­Å½ËœÃ¬ï¿½Â´Ã¬Â§â‚¬'
        },
        menu: {
          text: 'Ã¬Â»Â¬Ã«Å¸Â¼Ã¬ï¿½â€ž Ã¬â€žÂ Ã­Æ’ï¿½Ã­â€¢ËœÃ¬â€žÂ¸Ã¬Å¡â€�:'
        },
        sort: {
          ascending: 'Ã¬ËœÂ¤Ã«Â¦â€žÃ¬Â°Â¨Ã¬Ë†Å“ Ã¬Â â€¢Ã«Â Â¬',
          descending: 'Ã«â€šÂ´Ã«Â¦Â¼Ã¬Â°Â¨Ã¬Ë†Å“ Ã¬Â â€¢Ã«Â Â¬',
          remove: 'Ã¬â€ Å’Ã­Å’â€¦ Ã¬Â Å“ÃªÂ±Â°'
        },
        column: {
          hide: 'Ã¬Â»Â¬Ã«Å¸Â¼ Ã¬Â Å“ÃªÂ±Â°'
        },
        aggregation: {
          count: 'Ã¬Â â€žÃ¬Â²Â´ ÃªÂ°Â¯Ã¬Ë†Ëœ: ',
          sum: 'Ã¬Â â€žÃ¬Â²Â´: ',
          avg: 'Ã­ï¿½â€°ÃªÂ·Â : ',
          min: 'Ã¬ÂµÅ“Ã¬â€ Å’: ',
          max: 'Ã¬ÂµÅ“Ã«Å’â‚¬: '
        ...
        pinning: {
         pinLeft: 'Ã¬â„¢Â¼Ã¬ÂªÂ½ Ã­â€¢â‚¬',
          pinRight: 'Ã¬ËœÂ¤Ã«Â¥Â¸Ã¬ÂªÂ½ Ã­â€¢â‚¬',
          unpin: 'Ã­â€¢â‚¬ Ã¬Â Å“ÃªÂ±Â°'
        },
        gridMenu: {
          columns: 'Ã¬Â»Â¬Ã«Å¸Â¼:',
          importerTitle: 'Ã­Å’Å’Ã¬ï¿½Â¼ ÃªÂ°â‚¬Ã¬Â Â¸Ã¬ËœÂ¤ÃªÂ¸Â°',
          exporterAllAsCsv: 'csvÃ«Â¡Å“ Ã«ÂªÂ¨Ã«â€œÂ  Ã«ï¿½Â°Ã¬ï¿½Â´Ã­â€žÂ° Ã«â€šÂ´Ã«Â³Â´Ã«â€šÂ´ÃªÂ¸Â°',
          exporterVisibleAsCsv: 'csvÃ«Â¡Å“ Ã«Â³Â´Ã¬ï¿½Â´Ã«Å â€� Ã«ï¿½Â°Ã¬ï¿½Â´Ã­â€žÂ° Ã«â€šÂ´Ã«Â³Â´Ã«â€šÂ´ÃªÂ¸Â°',
          exporterSelectedAsCsv: 'csvÃ«Â¡Å“ Ã¬â€žÂ Ã­Æ’ï¿½Ã«ï¿½Å“ Ã«ï¿½Â°Ã¬ï¿½Â´Ã­â€žÂ° Ã«â€šÂ´Ã«Â³Â´Ã«â€šÂ´ÃªÂ¸Â°',
          exporterAllAsPdf: 'pdfÃ«Â¡Å“ Ã«ÂªÂ¨Ã«â€œÂ  Ã«ï¿½Â°Ã¬ï¿½Â´Ã­â€žÂ° Ã«â€šÂ´Ã«Â³Â´Ã«â€šÂ´ÃªÂ¸Â°',
          exporterVisibleAsPdf: 'pdfÃ«Â¡Å“ Ã«Â³Â´Ã¬ï¿½Â´Ã«Å â€� Ã«ï¿½Â°Ã¬ï¿½Â´Ã­â€žÂ° Ã«â€šÂ´Ã«Â³Â´Ã«â€šÂ´ÃªÂ¸Â°',
          exporterSelectedAsPdf: 'pdfÃ«Â¡Å“ Ã¬â€žÂ Ã­Æ’ï¿½ Ã«ï¿½Â°Ã¬ï¿½Â´Ã­â€žÂ° Ã«â€šÂ´Ã«Â³Â´Ã«â€šÂ´ÃªÂ¸Â°'
        },
        importer: {
          noHeaders: 'Ã¬Â»Â¬Ã«Å¸Â¼Ã«Âªâ€¦Ã¬ï¿½Â´ Ã¬Â§â‚¬Ã¬Â â€¢Ã«ï¿½ËœÃ¬â€“Â´ Ã¬Å¾Ë†Ã¬Â§â‚¬ Ã¬â€¢Å Ã¬Å ÂµÃ«â€¹Ë†Ã«â€¹Â¤. Ã­Å’Å’Ã¬ï¿½Â¼Ã¬â€”ï¿½ Ã­â€”Â¤Ã«ï¿½â€�ÃªÂ°â‚¬ Ã«Âªâ€¦Ã¬â€¹Å“Ã«ï¿½ËœÃ¬â€“Â´ Ã¬Å¾Ë†Ã«Å â€�Ã¬Â§â‚¬ Ã­â„¢â€¢Ã¬ï¿½Â¸Ã­â€¢Â´ Ã¬Â£Â¼Ã¬â€žÂ¸Ã¬Å¡â€�.',
          noObjects: 'Ã«ï¿½Â°Ã¬ï¿½Â´Ã­â€žÂ°ÃªÂ°â‚¬ Ã¬Â§â‚¬Ã¬Â â€¢Ã«ï¿½ËœÃ¬â€“Â´ Ã¬Å¾Ë†Ã¬Â§â‚¬ Ã¬â€¢Å Ã¬Å ÂµÃ«â€¹Ë†Ã«â€¹Â¤. Ã«ï¿½Â°Ã¬ï¿½Â´Ã­â€žÂ°ÃªÂ°â‚¬ Ã­Å’Å’Ã¬ï¿½Â¼Ã¬â€”ï¿½ Ã¬Å¾Ë†Ã«Å â€�Ã¬Â§â‚¬ Ã­â„¢â€¢Ã¬ï¿½Â¸Ã­â€¢Â´ Ã¬Â£Â¼Ã¬â€žÂ¸Ã¬Å¡â€�.',
          invalidCsv: 'Ã­Å’Å’Ã¬ï¿½Â¼Ã¬ï¿½â€ž Ã¬Â²ËœÃ«Â¦Â¬Ã­â€¢Â  Ã¬Ë†Ëœ Ã¬â€”â€ Ã¬Å ÂµÃ«â€¹Ë†Ã«â€¹Â¤. Ã¬ËœÂ¬Ã«Â°â€�Ã«Â¥Â¸ csvÃ¬ï¿½Â¸Ã¬Â§â‚¬ Ã­â„¢â€¢Ã¬ï¿½Â¸Ã­â€¢Â´ Ã¬Â£Â¼Ã¬â€žÂ¸Ã¬Å¡â€�.',
          invalidJson: 'Ã­Å’Å’Ã¬ï¿½Â¼Ã¬ï¿½â€ž Ã¬Â²ËœÃ«Â¦Â¬Ã­â€¢Â  Ã¬Ë†Ëœ Ã¬â€”â€ Ã¬Å ÂµÃ«â€¹Ë†Ã«â€¹Â¤. Ã¬ËœÂ¬Ã«Â°â€�Ã«Â¥Â¸ jsonÃ¬ï¿½Â¸Ã¬Â§â‚¬ Ã­â„¢â€¢Ã¬ï¿½Â¸Ã­â€¢Â´ Ã¬Â£Â¼Ã¬â€žÂ¸Ã¬Å¡â€�.',
          jsonNotArray: 'json Ã­Å’Å’Ã¬ï¿½Â¼Ã¬ï¿½â‚¬ Ã«Â°Â°Ã¬â€”Â´Ã¬ï¿½â€ž Ã­ï¿½Â¬Ã­â€¢Â¨Ã­â€¢Â´Ã¬â€¢Â¼ Ã­â€¢Â©Ã«â€¹Ë†Ã«â€¹Â¤.'
        },
        pagination: {
          sizes: 'Ã­Å½ËœÃ¬ï¿½Â´Ã¬Â§â‚¬Ã«â€¹Â¹ Ã­â€¢Â­Ã«ÂªÂ©',
          totalItems: 'Ã¬Â â€žÃ¬Â²Â´ Ã­â€¢Â­Ã«ÂªÂ©'
        }
      });
      return $delegate;
    ...
    $provide.decorator('i18nService', ['$delegate', function($delegate) {
      $delegate.add('pt-br', {
        ...
        search: {
          ...
          size: 'Tamanho da PÃƒÂ¡gina:',
          first: 'Primeira PÃƒÂ¡gina',
          next: 'PrÃƒÂ³xima PÃƒÂ¡gina',
          previous: 'PÃƒÂ¡gina Anterior',
          last: 'ÃƒÅ¡ltima PÃƒÂ¡gina'
        },
        menu: {
        ...
        sort: {
          ...
          remove: 'Remover OrdenaÃƒÂ§ÃƒÂ£o'
        },
        column: {
        ...
        gridMenu: {
          ...
          exporterVisibleAsCsv: 'Exportar dados visÃƒÂ­veis como csv',
          exporterSelectedAsCsv: 'Exportar dados selecionados como csv',
          exporterAllAsPdf: 'Exportar todos os dados como pdf',
          exporterVisibleAsPdf: 'Exportar dados visÃƒÂ­veis como pdf',
          exporterSelectedAsPdf: 'Exportar dados selecionados como pdf'
        },
        importer: {
          noHeaders: 'Nomes de colunas nÃƒÂ£o puderam ser derivados. O arquivo tem um cabeÃƒÂ§alho?',
          noObjects: 'Objetos nÃƒÂ£o puderam ser derivados. Havia dados no arquivo, alÃƒÂ©m dos cabeÃƒÂ§alhos?',
          invalidCsv: 'Arquivo nÃƒÂ£o pode ser processado. Ãƒâ€° um CSV vÃƒÂ¡lido?',
          invalidJson: 'Arquivo nÃƒÂ£o pode ser processado. Ãƒâ€° um Json vÃƒÂ¡lido?',
          jsonNotArray: 'Arquivo json importado tem que conter um array. Abortando.'
        },
        pagination: {
          sizes: 'itens por pÃƒÂ¡gina',
          totalItems: 'itens'
        },
        grouping: {
          group: 'Agrupar',
  ...
  angular.module('ui.grid').config(['$provide', function($provide) {
    $provide.decorator('i18nService', ['$delegate', function($delegate) {
      $delegate.add('pt', {
        ...
        importer: {
          noHeaders: 'Nomes de colunas nÃƒÂ£o puderam ser derivados. O ficheiro tem um cabeÃƒÂ§alho?',
          noObjects: 'Objetos nÃƒÂ£o puderam ser derivados. Havia dados no ficheiro, alÃƒÂ©m dos cabeÃƒÂ§alhos?',
          invalidCsv: 'Ficheiro nÃƒÂ£o pode ser processado. Ãƒâ€° um CSV vÃƒÂ¡lido?',
          invalidJson: 'Ficheiro nÃƒÂ£o pode ser processado. Ãƒâ€° um Json vÃƒÂ¡lido?',
...
(function () {
  angular.module('ui.grid').config(['$provide', function($provide) {
    $provide.decorator('i18nService', ['$delegate', function($delegate) {
      $delegate.add('ru', {
        aggregate: {
          label: 'Ã‘ï¿½Ã�Â»Ã�ÂµÃ�Â¼Ã�ÂµÃ�Â½Ã‘â€šÃ‘â€¹'
        },
        groupPanel: {
          description: 'Ã�â€�Ã�Â»Ã‘ï¿½ Ã�Â³Ã‘â‚¬Ã‘Æ’Ã�Â¿Ã�Â¿Ã�Â¸Ã‘â‚¬Ã�Â¾Ã�Â²Ã�ÂºÃ�Â¸ Ã�Â¿Ã�Â¾ Ã‘ï¿½Ã‘â€šÃ�Â¾Ã�Â»Ã�Â±Ã‘â€ Ã‘Æ’ Ã�Â¿Ã�ÂµÃ‘â‚¬Ã�ÂµÃ‘â€šÃ�Â°Ã‘â€°Ã�Â¸Ã‘â€šÃ�Âµ Ã‘ï¿½Ã‘Å½Ã�Â´Ã�Â° Ã�ÂµÃ�Â³Ã�Â¾ Ã�Â½Ã�Â°Ã�Â·Ã�Â²Ã�Â°Ã�Â½Ã�Â¸Ã�Âµ.'
        },
        search: {
          placeholder: 'Ã�Å¸Ã�Â¾Ã�Â¸Ã‘ï¿½Ã�Âº...',
          showingItems: 'Ã�Å¸Ã�Â¾Ã�ÂºÃ�Â°Ã�Â·Ã�Â°Ã‘â€šÃ‘Å’ Ã‘ï¿½Ã�Â»Ã�ÂµÃ�Â¼Ã�ÂµÃ�Â½Ã‘â€šÃ‘â€¹:',
          selectedItems: 'Ã�â€™Ã‘â€¹Ã�Â±Ã‘â‚¬Ã�Â°Ã�Â½Ã�Â½Ã‘â€¹Ã�Âµ Ã‘ï¿½Ã�Â»Ã�ÂµÃ�Â¼Ã�ÂµÃ�Â½Ã‘â€šÃ‘â€¹:',
          totalItems: 'Ã�â€™Ã‘ï¿½Ã�ÂµÃ�Â³Ã�Â¾ Ã‘ï¿½Ã�Â»Ã�ÂµÃ�Â¼Ã�ÂµÃ�Â½Ã‘â€šÃ�Â¾Ã�Â²:',
          size: 'Ã�Â Ã�Â°Ã�Â·Ã�Â¼Ã�ÂµÃ‘â‚¬ Ã‘ï¿½Ã‘â€šÃ‘â‚¬Ã�Â°Ã�Â½Ã�Â¸Ã‘â€ Ã‘â€¹:',
          first: 'Ã�Å¸Ã�ÂµÃ‘â‚¬Ã�Â²Ã�Â°Ã‘ï¿½ Ã‘ï¿½Ã‘â€šÃ‘â‚¬Ã�Â°Ã�Â½Ã�Â¸Ã‘â€ Ã�Â°',
          next: 'Ã�Â¡Ã�Â»Ã�ÂµÃ�Â´Ã‘Æ’Ã‘Å½Ã‘â€°Ã�Â°Ã‘ï¿½ Ã‘ï¿½Ã‘â€šÃ‘â‚¬Ã�Â°Ã�Â½Ã�Â¸Ã‘â€ Ã�Â°',
          previous: 'Ã�Å¸Ã‘â‚¬Ã�ÂµÃ�Â´Ã‘â€¹Ã�Â´Ã‘Æ’Ã‘â€°Ã�Â°Ã‘ï¿½ Ã‘ï¿½Ã‘â€šÃ‘â‚¬Ã�Â°Ã�Â½Ã�Â¸Ã‘â€ Ã�Â°',
          last: 'Ã�Å¸Ã�Â¾Ã‘ï¿½Ã�Â»Ã�ÂµÃ�Â´Ã�Â½Ã‘ï¿½Ã‘ï¿½ Ã‘ï¿½Ã‘â€šÃ‘â‚¬Ã�Â°Ã�Â½Ã�Â¸Ã‘â€ Ã�Â°'
        },
        menu: {
          text: 'Ã�â€™Ã‘â€¹Ã�Â±Ã‘â‚¬Ã�Â°Ã‘â€šÃ‘Å’ Ã‘ï¿½Ã‘â€šÃ�Â¾Ã�Â»Ã�Â±Ã‘â€ Ã‘â€¹:'
        },
        sort: {
          ascending: 'Ã�Å¸Ã�Â¾ Ã�Â²Ã�Â¾Ã�Â·Ã‘â‚¬Ã�Â°Ã‘ï¿½Ã‘â€šÃ�Â°Ã�Â½Ã�Â¸Ã‘Å½',
          descending: 'Ã�Å¸Ã�Â¾ Ã‘Æ’Ã�Â±Ã‘â€¹Ã�Â²Ã�Â°Ã�Â½Ã�Â¸Ã‘Å½',
          remove: 'Ã�Â£Ã�Â±Ã‘â‚¬Ã�Â°Ã‘â€šÃ‘Å’ Ã‘ï¿½Ã�Â¾Ã‘â‚¬Ã‘â€šÃ�Â¸Ã‘â‚¬Ã�Â¾Ã�Â²Ã�ÂºÃ‘Æ’'
        },
        column: {
          hide: 'Ã‘ï¿½Ã�Â¿Ã‘â‚¬Ã‘ï¿½Ã‘â€šÃ�Â°Ã‘â€šÃ‘Å’ Ã‘ï¿½Ã‘â€šÃ�Â¾Ã�Â»Ã�Â±Ã�ÂµÃ‘â€ '
        },
        aggregation: {
          count: 'Ã�Â²Ã‘ï¿½Ã�ÂµÃ�Â³Ã�Â¾ Ã‘ï¿½Ã‘â€šÃ‘â‚¬Ã�Â¾Ã�Âº: ',
          sum: 'Ã�Â¸Ã‘â€šÃ�Â¾Ã�Â³Ã�Â¾: ',
          avg: 'Ã‘ï¿½Ã‘â‚¬Ã�ÂµÃ�Â´Ã�Â½Ã�ÂµÃ�Âµ: ',
          min: 'Ã�Â¼Ã�Â¸Ã�Â½: ',
          max: 'Ã�Â¼Ã�Â°Ã�ÂºÃ‘ï¿½: '
        },
        gridMenu: {
          columns: 'Ã�Â¡Ã‘â€šÃ�Â¾Ã�Â»Ã�Â±Ã‘â€ Ã‘â€¹:',
          importerTitle: 'Import file',
          exporterAllAsCsv: 'Ã�Â­Ã�ÂºÃ‘ï¿½Ã�Â¿Ã�Â¾Ã‘â‚¬Ã‘â€šÃ�Â¸Ã‘â‚¬Ã�Â¾Ã�Â²Ã�Â°Ã‘â€šÃ‘Å’ Ã�Â²Ã‘ï¿½Ã‘â€˜ Ã�Â² CSV',
          exporterVisibleAsCsv: 'Ã�Â­Ã�ÂºÃ‘ï¿½Ã�Â¿Ã�Â¾Ã‘â‚¬Ã‘â€šÃ�Â¸Ã‘â‚¬Ã�Â¾Ã�Â²Ã�Â°Ã‘â€šÃ‘Å’ Ã�Â²Ã�Â¸Ã�Â´Ã�Â¸Ã�Â¼Ã‘â€¹Ã�Âµ Ã�Â´Ã�Â°Ã�Â½Ã�Â½Ã‘â€¹Ã�Âµ Ã�Â² CSV',
          exporterSelectedAsCsv: 'Ã�Â­Ã�ÂºÃ‘ï¿½Ã�Â¿Ã�Â¾Ã‘â‚¬Ã‘â€šÃ�Â¸Ã‘â‚¬Ã�Â¾Ã�Â²Ã�Â°Ã‘â€šÃ‘Å’ Ã�Â²Ã‘â€¹Ã�Â±Ã‘â‚¬Ã�Â°Ã�Â½Ã�Â½Ã‘â€¹Ã�Âµ Ã�Â´Ã�Â°Ã�Â½Ã�Â½Ã‘â€¹Ã�Âµ Ã�Â² CSV',
          exporterAllAsPdf: 'Ã�Â­Ã�ÂºÃ‘ï¿½Ã�Â¿Ã�Â¾Ã‘â‚¬Ã‘â€šÃ�Â¸Ã‘â‚¬Ã�Â¾Ã�Â²Ã�Â°Ã‘â€šÃ‘Å’ Ã�Â²Ã‘ï¿½Ã‘â€˜ Ã�Â² PDF',
          exporterVisibleAsPdf: 'Ã�Â­Ã�ÂºÃ‘ï¿½Ã�Â¿Ã�Â¾Ã‘â‚¬Ã‘â€šÃ�Â¸Ã‘â‚¬Ã�Â¾Ã�Â²Ã�Â°Ã‘â€šÃ‘Å’ Ã�Â²Ã�Â¸Ã�Â´Ã�Â¸Ã�Â¼Ã‘â€¹Ã�Âµ Ã�Â´Ã�Â°Ã�Â½Ã�Â½Ã‘â€¹Ã�Âµ Ã�Â² PDF',
          exporterSelectedAsPdf: 'Ã�Â­Ã�ÂºÃ‘ï¿½Ã�Â¿Ã�Â¾Ã‘â‚¬Ã‘â€šÃ�Â¸Ã‘â‚¬Ã�Â¾Ã�Â²Ã�Â°Ã‘â€šÃ‘Å’ Ã�Â²Ã‘â€¹Ã�Â±Ã‘â‚¬Ã�Â°Ã�Â½Ã�Â½Ã‘â€¹Ã�Âµ Ã�Â´Ã�Â°Ã�Â½Ã�Â½Ã‘â€¹Ã�Âµ Ã�Â² PDF'
        },
        importer: {
          noHeaders: 'Column names were unable to be derived, does the file have a header?',
          noObjects: 'Objects were not able to be derived, was there data in the file other than headers?',
  ...
  angular.module('ui.grid').config(['$provide', function($provide) {
    $provide.decorator('i18nService', ['$delegate', function($delegate) {
      $delegate.add('sk', {
        ...
        groupPanel: {
          description: 'Pretiahni sem nÃƒÂ¡zov stÃ„Âºpca pre zoskupenie podÃ„Â¾a toho stÃ„Âºpca.'
        },
        search: {
          placeholder: 'HÃ„Â¾adaj...',
          showingItems: 'Zobrazujem poloÃ…Â¾ky:',
          selectedItems: 'VybratÃƒÂ© poloÃ…Â¾ky:',
          totalItems: 'PoÃ„ï¿½et poloÃ…Â¾iek:',
          size: 'PoÃ„ï¿½et:',
          first: 'PrvÃƒÂ¡ strana',
          next: 'Ã„Å½alÃ…Â¡ia strana',
          previous: 'PredchÃƒÂ¡dzajÃƒÂºca strana',
          last: 'PoslednÃƒÂ¡ strana'
        },
        menu: {
          text: 'Vyberte stÃ„Âºpce:'
        },
        sort: {
          ascending: 'ZotriediÃ…Â¥ vzostupne',
          descending: 'ZotriediÃ…Â¥ zostupne',
          remove: 'VymazaÃ…Â¥ triedenie'
        },
        aggregation: {
          count: 'total rows: ',
          sum: 'total: ',
  ...
  angular.module('ui.grid').config(['$provide', function($provide) {
    $provide.decorator('i18nService', ['$delegate', function($delegate) {
      $delegate.add('sv', {
        ...
        groupPanel: {
          description: 'Dra en kolumnrubrik hit och slÃƒÂ¤pp den fÃƒÂ¶r att gruppera efter den kolumnen.'
        },
        search: {
          placeholder: 'SÃƒÂ¶k...',
          ...
          size: 'Sidstorlek:',
          first: 'FÃƒÂ¶rsta sidan',
          next: 'NÃƒÂ¤sta sida',
          previous: 'FÃƒÂ¶regÃƒÂ¥ende sida',
          last: 'Sista sidan'
        },
        menu: {
          text: 'VÃƒÂ¤lj kolumner:'
        },
        sort: {
        ...
        pinning: {
          pinLeft: 'FÃƒÂ¤st vÃƒÂ¤nster',
          pinRight: 'FÃƒÂ¤st hÃƒÂ¶ger',
          unpin: 'LÃƒÂ¶sgÃƒÂ¶r'
        },
        gridMenu: {
          columns: 'Kolumner:',
        ...
        importer: {
          noHeaders: 'Kolumnnamn kunde inte hÃƒÂ¤rledas. Har filen ett sidhuvud?',
          noObjects: 'Objekt kunde inte hÃƒÂ¤rledas. Har filen data undantaget sidhuvud?',
          invalidCsv: 'Filen kunde inte behandlas, ÃƒÂ¤r den en giltig CSV?',
          invalidJson: 'Filen kunde inte behandlas, ÃƒÂ¤r den en giltig JSON?',
          jsonNotArray: 'Importerad JSON-fil mÃƒÂ¥ste innehÃƒÂ¥lla ett fÃƒÂ¤lt. Import avbruten.'
        },
        pagination: {
  ...
  angular.module('ui.grid').config(['$provide', function($provide) {
    $provide.decorator('i18nService', ['$delegate', function($delegate) {
      $delegate.add('zh-cn', {
        ...
        groupPanel: {
          description: 'Ã¦â€¹â€“Ã¦â€ºÂ³Ã¨Â¡Â¨Ã¥Â¤Â´Ã¥Ë†Â°Ã¦Â­Â¤Ã¥Â¤â€žÃ¨Â¿â€ºÃ¨Â¡Å’Ã¥Ë†â€ Ã§Â»â€ž'
        },
        search: {
          placeholder: 'Ã¦Å¸Â¥Ã¦â€°Â¾',
          showingItems: 'Ã¥Â·Â²Ã¦ËœÂ¾Ã§Â¤ÂºÃ¨Â¡Å’Ã¦â€¢Â°Ã¯Â¼Å¡',
          selectedItems: 'Ã¥Â·Â²Ã©â‚¬â€°Ã¦â€¹Â©Ã¨Â¡Å’Ã¦â€¢Â°Ã¯Â¼Å¡',
          totalItems: 'Ã¦â‚¬Â»Ã¨Â¡Å’Ã¦â€¢Â°Ã¯Â¼Å¡',
          size: 'Ã¦Â¯ï¿½Ã©Â¡ÂµÃ¦ËœÂ¾Ã§Â¤ÂºÃ¨Â¡Å’Ã¦â€¢Â°Ã¯Â¼Å¡',
          first: 'Ã©Â¦â€“Ã©Â¡Âµ',
          next: 'Ã¤Â¸â€¹Ã¤Â¸â‚¬Ã©Â¡Âµ',
          previous: 'Ã¤Â¸Å Ã¤Â¸â‚¬Ã©Â¡Âµ',
          last: 'Ã¦Å“Â«Ã©Â¡Âµ'
        },
        menu: {
          text: 'Ã©â‚¬â€°Ã¦â€¹Â©Ã¥Ë†â€”Ã¯Â¼Å¡'
        },
        sort: {
          ascending: 'Ã¥ï¿½â€¡Ã¥Âºï¿½',
          descending: 'Ã©â„¢ï¿½Ã¥Âºï¿½',
          remove: 'Ã¥ï¿½â€“Ã¦Â¶Ë†Ã¦Å½â€™Ã¥Âºï¿½'
        },
        column: {
          hide: 'Ã©Å¡ï¿½Ã¨â€”ï¿½Ã¥Ë†â€”'
        },
        aggregation: {
          count: 'Ã¨Â®Â¡Ã¦â€¢Â°Ã¯Â¼Å¡',
          sum: 'Ã¦Â±â€šÃ¥â€™Å’Ã¯Â¼Å¡',
          avg: 'Ã¥ï¿½â€¡Ã¥â‚¬Â¼Ã¯Â¼Å¡',
          min: 'Ã¦Å“â‚¬Ã¥Â°ï¿½Ã¥â‚¬Â¼Ã¯Â¼Å¡',
          max: 'Ã¦Å“â‚¬Ã¥Â¤Â§Ã¥â‚¬Â¼Ã¯Â¼Å¡'
        },
        pinning: {
          pinLeft: 'Ã¥Â·Â¦Ã¤Â¾Â§Ã¥â€ºÂºÃ¥Â®Å¡',
          pinRight: 'Ã¥ï¿½Â³Ã¤Â¾Â§Ã¥â€ºÂºÃ¥Â®Å¡',
          unpin: 'Ã¥ï¿½â€“Ã¦Â¶Ë†Ã¥â€ºÂºÃ¥Â®Å¡'
        },
        gridMenu: {
          columns: 'Ã¥Ë†â€”Ã¯Â¼Å¡',
          importerTitle: 'Ã¥Â¯Â¼Ã¥â€¦Â¥Ã¦â€“â€¡Ã¤Â»Â¶',
          exporterAllAsCsv: 'Ã¥Â¯Â¼Ã¥â€¡ÂºÃ¥â€¦Â¨Ã©Æ’Â¨Ã¦â€¢Â°Ã¦ï¿½Â®Ã¥Ë†Â°CSV',
          exporterVisibleAsCsv: 'Ã¥Â¯Â¼Ã¥â€¡ÂºÃ¥ï¿½Â¯Ã¨Â§ï¿½Ã¦â€¢Â°Ã¦ï¿½Â®Ã¥Ë†Â°CSV',
          exporterSelectedAsCsv: 'Ã¥Â¯Â¼Ã¥â€¡ÂºÃ¥Â·Â²Ã©â‚¬â€°Ã¦â€¢Â°Ã¦ï¿½Â®Ã¥Ë†Â°CSV',
          exporterAllAsPdf: 'Ã¥Â¯Â¼Ã¥â€¡ÂºÃ¥â€¦Â¨Ã©Æ’Â¨Ã¦â€¢Â°Ã¦ï¿½Â®Ã¥Ë†Â°PDF',
          exporterVisibleAsPdf: 'Ã¥Â¯Â¼Ã¥â€¡ÂºÃ¥ï¿½Â¯Ã¨Â§ï¿½Ã¦â€¢Â°Ã¦ï¿½Â®Ã¥Ë†Â°PDF',
          exporterSelectedAsPdf: 'Ã¥Â¯Â¼Ã¥â€¡ÂºÃ¥Â·Â²Ã©â‚¬â€°Ã¦â€¢Â°Ã¦ï¿½Â®Ã¥Ë†Â°PDF'
        },
        importer: {
          noHeaders: 'Ã¦â€”Â Ã¦Â³â€¢Ã¨Å½Â·Ã¥ï¿½â€“Ã¥Ë†â€”Ã¥ï¿½ï¿½Ã¯Â¼Å’Ã§Â¡Â®Ã¥Â®Å¡Ã¦â€“â€¡Ã¤Â»Â¶Ã¥Å’â€¦Ã¥ï¿½Â«Ã¨Â¡Â¨Ã¥Â¤Â´Ã¯Â¼Å¸',
          noObjects: 'Ã¦â€”Â Ã¦Â³â€¢Ã¨Å½Â·Ã¥ï¿½â€“Ã¦â€¢Â°Ã¦ï¿½Â®Ã¯Â¼Å’Ã§Â¡Â®Ã¥Â®Å¡Ã¦â€“â€¡Ã¤Â»Â¶Ã¥Å’â€¦Ã¥ï¿½Â«Ã¦â€¢Â°Ã¦ï¿½Â®Ã¯Â¼Å¸',
          invalidCsv: 'Ã¦â€”Â Ã¦Â³â€¢Ã¥Â¤â€žÃ§ï¿½â€ Ã¦â€“â€¡Ã¤Â»Â¶Ã¯Â¼Å’Ã§Â¡Â®Ã¥Â®Å¡Ã¦ËœÂ¯Ã¥ï¿½Ë†Ã¦Â³â€¢Ã§Å¡â€žCSVÃ¦â€“â€¡Ã¤Â»Â¶Ã¯Â¼Å¸',
          invalidJson: 'Ã¦â€”Â Ã¦Â³â€¢Ã¥Â¤â€žÃ§ï¿½â€ Ã¦â€“â€¡Ã¤Â»Â¶Ã¯Â¼Å’Ã§Â¡Â®Ã¥Â®Å¡Ã¦ËœÂ¯Ã¥ï¿½Ë†Ã¦Â³â€¢Ã§Å¡â€žJSONÃ¦â€“â€¡Ã¤Â»Â¶Ã¯Â¼Å¸',
          jsonNotArray: 'Ã¥Â¯Â¼Ã¥â€¦Â¥Ã§Å¡â€žÃ¦â€“â€¡Ã¤Â»Â¶Ã¤Â¸ï¿½Ã¦ËœÂ¯JSONÃ¦â€¢Â°Ã§Â»â€žÃ¯Â¼ï¿½'
        },
        pagination: {
          sizes: 'Ã¨Â¡Å’Ã¦Â¯ï¿½Ã©Â¡Âµ',
          totalItems: 'Ã¨Â¡Å’'
        }
      });
      return $delegate;
  ...
  angular.module('ui.grid').config(['$provide', function($provide) {
    $provide.decorator('i18nService', ['$delegate', function($delegate) {
      $delegate.add('zh-tw', {
        ...
        groupPanel: {
          description: 'Ã¦â€¹â€“Ã¦â€ºÂ³Ã¨Â¡Â¨Ã©Â Â­Ã¥Ë†Â°Ã¦Â­Â¤Ã¨â„¢â€¢Ã©â‚¬Â²Ã¨Â¡Å’Ã¥Ë†â€ Ã§Âµâ€ž'
        },
        search: {
          placeholder: 'Ã¦Å¸Â¥Ã¦â€°Â¾',
          showingItems: 'Ã¥Â·Â²Ã©Â¡Â¯Ã§Â¤ÂºÃ¨Â¡Å’Ã¦â€¢Â¸Ã¯Â¼Å¡',
          selectedItems: 'Ã¥Â·Â²Ã©ï¿½Â¸Ã¦â€œâ€¡Ã¨Â¡Å’Ã¦â€¢Â¸Ã¯Â¼Å¡',
          totalItems: 'Ã§Â¸Â½Ã¨Â¡Å’Ã¦â€¢Â¸Ã¯Â¼Å¡',
          size: 'Ã¦Â¯ï¿½Ã©Â ï¿½Ã©Â¡Â¯Ã§Â¤ÂºÃ¨Â¡Å’Ã¦â€¢Â¸Ã¯Â¼Å¡',
          first: 'Ã©Â¦â€“Ã©Â ï¿½',
          next: 'Ã¤Â¸â€¹Ã¥Â£Â¹Ã©Â ï¿½',
          previous: 'Ã¤Â¸Å Ã¥Â£Â¹Ã©Â ï¿½',
          last: 'Ã¦Å“Â«Ã©Â ï¿½'
        },
        menu: {
          text: 'Ã©ï¿½Â¸Ã¦â€œâ€¡Ã¥Ë†â€”Ã¯Â¼Å¡'
        },
        sort: {
          ascending: 'Ã¥ï¿½â€¡Ã¥Âºï¿½',
          descending: 'Ã©â„¢ï¿½Ã¥Âºï¿½',
        ...
        column: {
          hide: 'Ã©Å¡Â±Ã¨â€”ï¿½Ã¥Ë†â€”'
        },
        aggregation: {
          count: 'Ã¨Â¨Ë†Ã¦â€¢Â¸Ã¯Â¼Å¡',
          sum: 'Ã¦Â±â€šÃ¥â€™Å’Ã¯Â¼Å¡',
          avg: 'Ã¥ï¿½â€¡Ã¥â‚¬Â¼Ã¯Â¼Å¡',
          min: 'Ã¦Å“â‚¬Ã¥Â°ï¿½Ã¥â‚¬Â¼Ã¯Â¼Å¡',
          max: 'Ã¦Å“â‚¬Ã¥Â¤Â§Ã¥â‚¬Â¼Ã¯Â¼Å¡'
        ...
        pinning: {
          pinLeft: 'Ã¥Â·Â¦Ã¥ï¿½Â´Ã¥â€ºÂºÃ¥Â®Å¡',
          pinRight: 'Ã¥ï¿½Â³Ã¥ï¿½Â´Ã¥â€ºÂºÃ¥Â®Å¡',
          unpin: 'Ã¥ï¿½â€“Ã¦Â¶Ë†Ã¥â€ºÂºÃ¥Â®Å¡'
        },
        gridMenu: {
          columns: 'Ã¥Ë†â€”Ã¯Â¼Å¡',
          importerTitle: 'Ã¥Â°Å½Ã¥â€¦Â¥Ã¦â€“â€¡Ã¤Â»Â¶',
          exporterAllAsCsv: 'Ã¥Â°Å½Ã¥â€¡ÂºÃ¥â€¦Â¨Ã©Æ’Â¨Ã¦â€¢Â¸Ã¦â€œÅ¡Ã¥Ë†Â°CSV',
          exporterVisibleAsCsv: 'Ã¥Â°Å½Ã¥â€¡ÂºÃ¥ï¿½Â¯Ã¨Â¦â€¹Ã¦â€¢Â¸Ã¦â€œÅ¡Ã¥Ë†Â°CSV',
          exporterSelectedAsCsv: 'Ã¥Â°Å½Ã¥â€¡ÂºÃ¥Â·Â²Ã©ï¿½Â¸Ã¦â€¢Â¸Ã¦â€œÅ¡Ã¥Ë†Â°CSV',
          exporterAllAsPdf: 'Ã¥Â°Å½Ã¥â€¡ÂºÃ¥â€¦Â¨Ã©Æ’Â¨Ã¦â€¢Â¸Ã¦â€œÅ¡Ã¥Ë†Â°PDF',
          exporterVisibleAsPdf: 'Ã¥Â°Å½Ã¥â€¡ÂºÃ¥ï¿½Â¯Ã¨Â¦â€¹Ã¦â€¢Â¸Ã¦â€œÅ¡Ã¥Ë†Â°PDF',
          exporterSelectedAsPdf: 'Ã¥Â°Å½Ã¥â€¡ÂºÃ¥Â·Â²Ã©ï¿½Â¸Ã¦â€¢Â¸Ã¦â€œÅ¡Ã¥Ë†Â°PDF'
        },
        importer: {
          noHeaders: 'Ã§â€žÂ¡Ã¦Â³â€¢Ã§ï¿½Â²Ã¥ï¿½â€“Ã¥Ë†â€”Ã¥ï¿½ï¿½Ã¯Â¼Å’Ã§Â¢ÂºÃ¥Â®Å¡Ã¦â€“â€¡Ã¤Â»Â¶Ã¥Å’â€¦Ã¥ï¿½Â«Ã¨Â¡Â¨Ã©Â Â­Ã¯Â¼Å¸',
          noObjects: 'Ã§â€žÂ¡Ã¦Â³â€¢Ã§ï¿½Â²Ã¥ï¿½â€“Ã¦â€¢Â¸Ã¦â€œÅ¡Ã¯Â¼Å’Ã§Â¢ÂºÃ¥Â®Å¡Ã¦â€“â€¡Ã¤Â»Â¶Ã¥Å’â€¦Ã¥ï¿½Â«Ã¦â€¢Â¸Ã¦â€œÅ¡Ã¯Â¼Å¸',
          invalidCsv: 'Ã§â€žÂ¡Ã¦Â³â€¢Ã¨â„¢â€¢Ã§ï¿½â€ Ã¦â€“â€¡Ã¤Â»Â¶Ã¯Â¼Å’Ã§Â¢ÂºÃ¥Â®Å¡Ã¦ËœÂ¯Ã¥ï¿½Ë†Ã¦Â³â€¢Ã§Å¡â€žCSVÃ¦â€“â€¡Ã¤Â»Â¶Ã¯Â¼Å¸',
          invalidJson: 'Ã§â€žÂ¡Ã¦Â³â€¢Ã¨â„¢â€¢Ã§ï¿½â€ Ã¦â€“â€¡Ã¤Â»Â¶Ã¯Â¼Å’Ã§Â¢ÂºÃ¥Â®Å¡Ã¦ËœÂ¯Ã¥ï¿½Ë†Ã¦Â³â€¢Ã§Å¡â€žJSONÃ¦â€“â€¡Ã¤Â»Â¶Ã¯Â¼Å¸',
          jsonNotArray: 'Ã¥Â°Å½Ã¥â€¦Â¥Ã§Å¡â€žÃ¦â€“â€¡Ã¤Â»Â¶Ã¤Â¸ï¿½Ã¦ËœÂ¯JSONÃ¦â€¢Â¸Ã§Âµâ€žÃ¯Â¼ï¿½'
        },
        pagination: {
          sizes: 'Ã¨Â¡Å’Ã¦Â¯ï¿½Ã©Â ï¿½',
          totalItems: 'Ã¨Â¡Å’'
        }
      });
      return $delegate;
    ...
    function ($q, uiGridExporterConstants, gridUtil, $compile, $interval, i18nService) {
      ...
      var service = {
        ...
        defaultGridOptions: function (gridOptions) {
           ...
           * through as ÃƒÂ¯Ã‚Â»Ã‚Â¿ in the first column header.  Setting this option to false will suppress this, at the
